...
typedef enum {
    ...
    /* V9 vision.bin uses the same aligned index/store format but independent files.
     * Block-local records use layer=0..26. Patch/final/projector records use GLOBAL_LAYER. */
    KVL_VISION_PATCH_WEIGHT = 100,
    KVL_VISION_PATCH_BIAS = 101,
    KVL_VISION_POS_EMB = 102,
    KVL_VISION_FINAL_NORM_WEIGHT = 103,
    KVL_VISION_FINAL_NORM_BIAS = 104,

    KVL_VISION_NORM0_WEIGHT = 110,
    KVL_VISION_NORM0_BIAS = 111,
    KVL_VISION_WQKV_WEIGHT = 112,
    KVL_VISION_WQKV_BIAS = 113,
    KVL_VISION_WO_WEIGHT = 114,
    KVL_VISION_WO_BIAS = 115,
    KVL_VISION_NORM1_WEIGHT = 116,
    KVL_VISION_NORM1_BIAS = 117,
    KVL_VISION_MLP0_WEIGHT = 118,
    KVL_VISION_MLP0_BIAS = 119,
    KVL_VISION_MLP1_WEIGHT = 120,
    KVL_VISION_MLP1_BIAS = 121,

    KVL_VISION_PROJECTOR_NORM_WEIGHT = 130,
    KVL_VISION_PROJECTOR_NORM_BIAS = 131,
    KVL_VISION_PROJECTOR_L1_WEIGHT = 132,
    KVL_VISION_PROJECTOR_L1_BIAS = 133,
    KVL_VISION_PROJECTOR_L2_WEIGHT = 134,
    KVL_VISION_PROJECTOR_L2_BIAS = 135
} KvlTrunkTensorKind;
